...
{
	private final PolicyIterationSatia subject = new PolicyIterationSatia(0.001);
	...
	public void oneStateWithNoNextStates() {
		...
		when(a.isApplicableTo(s)).thenReturn(true);
		when(mdpip.getAllActions()).thenReturn(ImmutableSet.of(a));
