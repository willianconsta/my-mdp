...
public final class MDPFileProblemReaderImpl {
	private static Logger log = LogManager.getLogger(MDPFileProblemReaderImpl.class);
	...
	public MDPFileProblemReaderImpl() {
		readingStates = false;
	...
	public MDP readFromFile(final String absoluteFilepath) {
		init();
